-- MiCancha — Esquema completo (referencia rápida).
-- La fuente de verdad es la migración versionada en: src/migrations/001_inicial.sql
-- Para aplicar el esquema, ejecuta: npm run migrate
